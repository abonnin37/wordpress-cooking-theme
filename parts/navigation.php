<nav class="navbar">
    ...
    <div class="google-traduction-selector">
        <?php if ((is_single() && get_post_type() === "wprm_recipe") || true) {
            echo do_shortcode('[google-translator]');
        }
        ?>
    </div>
    <div class="locale-selector">
        <div class="locale-selector-item locale-fr_FR" id="locale-fr_FR">
        ...
        <div class="locale-selector-item locale-pt_BR" id="locale-pt_BR">
